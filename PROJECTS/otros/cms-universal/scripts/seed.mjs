...
async function main() {
  ...
  const CATS = [
    ...
    { slug: "negocios", name: "Negocios", color: "#8b7355", description: "Economía, mercados y empresas" },
    { slug: "mundo", name: "Mundo", color: "#2c3e50", description: "Noticias internacionales" },
  ...
  const SOURCES = [
    ...
    { name: "BBC Mundo", type: "rss", url: "https://feeds.bbci.co.uk/mundo/rss.xml", language: "es",
      categories: [createdCats.mundo], maxArticlesPerFetch: 3 }
  ];
